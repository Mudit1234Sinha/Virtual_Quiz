...
while True:
    ...
    if qNo < qTotal:
        ...
        img, bbox1 = cvzone.putTextRect(img, mcq.choice1, [100, 350], 2, 2, offset=50, border=5)
        img, bbox2 = cvzone.putTextRect(img, mcq.choice2, [700, 350], 2, 2, offset=50, border=5)
        img, bbox3 = cvzone.putTextRect(img, mcq.choice3, [100, 500], 2, 2, offset=50, border=5)
        img, bbox4 = cvzone.putTextRect(img, mcq.choice4, [700, 500], 2, 2, offset=50, border=5)
